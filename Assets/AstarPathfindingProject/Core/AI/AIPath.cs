...
public class AIPath : MonoBehaviour {
	...
	public GameObject customerInfront;

	public Till targetTill;

	public bool beingServed = false;
	public bool shopComplete = false;
	...
	public virtual void SearchPath () {
		...
		Vector3 targetPosition = targetTill.tillObject.transform.position + new Vector3 (0, 0, 1);

		if (customerInfront != null) {
			if(customerInfront != this.gameObject)
			{
				targetPosition = customerInfront.transform.position + new Vector3 (1, 0, 0);
			}

			if(customerInfront.GetComponent<AIPath>().shopComplete)
			{
				targetPosition = targetTill.tillObject.transform.position + new Vector3(0,0,1);
			}
		}
		if(shopComplete)
		{
			targetPosition = new Vector3(-2.71f, 0.75f, 20f);
		}
	...
	public virtual void OnTargetReached () {
		...
		if(transform.position == targetTill.tillObject.transform.position + new Vector3(1,0,1))
		{
			beingServed = true;
		}
	}
